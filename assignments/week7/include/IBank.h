...
public:
    ...
    virtual int getNextAccountId() const = 0;
    virtual bool addAccount(Customer &customer, IAccount *account) = 0;
    ...
    virtual Customer *addCustomer(const std::string &name, const std::string &password) = 0;
    ...
    virtual int deposit(long accountNumber, int customerId, double amount) = 0;
    virtual int withdraw(long accountNumber, int customerId, double amount) = 0;
    ...
    virtual bool addAccountRequest(int customerId, double balance, const std::string &type) = 0;
